  ...
  methods: {
    ...
    dateFun(pDate) {
      ...
      if (self.endDate) {
        ...
        if (yarnSelectVal == yarnEndVal && mouSelectVal == endMou) {
          dayEndVal = endDate.getDate();
        } else {
          dayEndVal = self.mGetDate(self.yarVal, self.mouVal);
        }
      } else {
      ...
      if (self.startDate) {
        ...
        yarnStartVal = yarnStartVal - self.newDate.y;
        mouStartVal = startDate.getMonth() + 1;
        self.cutY.start = yarnStartVal;
        mouEndVal = 12;
        if (yarnSelectVal == startDate.getFullYear()) {
          mouDatasNum = mouStartVal;
          mouEndVal = 13 - mouStartVal;
        }
      }
      // 年
      let ytemp = [];
