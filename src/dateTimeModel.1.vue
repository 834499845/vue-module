...
export default {
  ...
  props: {
    ...
    sfix: {},
    type: {
      default: "5" // 1 年 2 年月 3 年月日 4 年月日时 5 年月日时分 6 年月日时分秒
    },
    value: {} // 最终值
  },
  data() {
  ...
  methods: {
    ...
    dateFun(pDate) {
      ...
      if (self.endDate) {
        ...
        if (
          yarnSelectVal == yarnEndVal &&
          mouSelectVal == mouEndVal &&
          daySelectVal == dayEndVal
        ) {
          self.cutH.end = hEndVal;
        } else {
          self.cutH.end = 23;
      ...
      if (self.startDate) {
        ...
        if (
          yarnSelectVal == yarnStartVal &&
          mouSelectVal == mouStartVal &&
          daySelectVal == dayStartVal
        ) {
          self.cutH.start = hStartVal;
        } else {
          self.cutH.start = 0;
